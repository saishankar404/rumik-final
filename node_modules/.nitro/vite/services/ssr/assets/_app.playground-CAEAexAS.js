import { o as Waveform$1 } from "./primitives-MhefxCVw.js";
import { Children, useCallback, useEffect, useRef, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowCounterClockwise, BookOpen, Brain, Broadcast, CaretRight, Check, Download, FilmSlate, GameController, Lightning, MagicWand, Microphone, Pause, Play, Smiley, Upload, X } from "@phosphor-icons/react";
...
//#endregion
//#region src/components/shell/speech-to-text.tsx
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: [...Array(visualizerBars)].map((_, i) => /* @__PURE__ */ jsx("div", {
...
function Waveform({ width = 300, height = 40, bars = 60 }) {
	...
	useEffect(() => {
		...
		for (let i = 0; i < bars; i++) {
			...
			newBars.push(/* @__PURE__ */ jsx("rect", {
				x,
				y: topY,
				width: barWidth,
				height: barHeight,
...
function AudioComponent({ isAnimating, filename = "audio.mp3", onRemove }) {
	...
	return /* @__PURE__ */ jsx(AnimatePresence, { children: shouldShow && /* @__PURE__ */ jsx(motion.div, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(UploadCardBase, {
							isDragOver,
							isUploading
						}), /* @__PURE__ */ jsx("input", {
							ref: fileInputRef,
...
//#endregion
//#region src/routes/_app.playground.tsx?tsr-split=component
var TAGS = [
	{
		tag: "laugh",
...
function Playground() {
	...
	const [experiments, setExperiments] = useState(SEED_EXPERIMENTS);
	const [tab, setTab] = useState("settings");
	const [flashedTag, setFlashedTag] = useState(null);
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
					...
					children: ["tts", "stt"].map((m) => /* @__PURE__ */ jsxs("button", {
						onClick: () => setMode(m),
						...
						children: [mode === m && /* @__PURE__ */ jsx(motion.div, {
				...
				mode: "wait",
				children: mode === "tts" ? /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						opacity: 0,
						y: 8
					},
					...
					children: [
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("button", {
										...
										children: [/* @__PURE__ */ jsx(MagicWand, { className: "h-3.5 w-3.5" }), "Enhance"]
									}),
									/* @__PURE__ */ jsxs("button", {
										onClick: () => setText(""),
										className: "inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-[13px] text-muted-foreground transition-colors hover:bg-[var(--inset)] hover:text-foreground active:scale-[0.96]",
										children: [/* @__PURE__ */ jsx(ArrowCounterClockwise, { className: "h-3.5 w-3.5" }), "Clear"]
									}),
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsx("span", { className: "h-3 w-px bg-border/60" }),
											/* @__PURE__ */ jsxs("span", {
												className: "font-display text-[12px] tabular-nums text-muted-foreground/50",
												children: [/* @__PURE__ */ jsx("span", {
											...
											/* @__PURE__ */ jsxs("button", {
												...
												children: [isGenerating && /* @__PURE__ */ jsx("span", { className: "h-3.5 w-3.5 rounded-full border-2 border-background/30 border-t-background animate-spin" }), isDone ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Check, {
													className: "h-3.5 w-3.5",
													strokeWidth: 2.5
												}), /* @__PURE__ */ jsxs("span", {
													className: "font-display tabular-nums",
													children: [lastLatencyMs, "ms"]
												})] }) : isGenerating ? /* @__PURE__ */ jsx("span", {
													className: "font-display text-background/70",
													children: "Generating…"
												}) : /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Play, {
													className: "h-3.5 w-3.5",
													fill: "currentColor"
												}), "Generate speech"] })]
											})
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(AnimatePresence, {
								mode: "wait",
								children: isEmpty ? /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										y: 8,
										filter: "blur(4px)"
									...
									children: [/* @__PURE__ */ jsx("p", {
										...
										children: STARTERS.map(({ Icon, label: sl, sample }) => /* @__PURE__ */ jsxs("button", {
								...
								}, "get-started") : /* @__PURE__ */ jsxs(motion.div, {
									initial: {
										opacity: 0,
										y: 8,
										filter: "blur(4px)"
						...
						/* @__PURE__ */ jsx(AnimatePresence, { children: isDone && /* @__PURE__ */ jsx(motion.div, {
							initial: {
								opacity: 0,
								y: 12,
								filter: "blur(4px)"
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: [...Array(64)].map((_, i) => /* @__PURE__ */ jsx("div", {
				...
				}, "tts-editor") : /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						opacity: 0,
						y: 8
					},
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: ["settings", "experiments"].map((t) => /* @__PURE__ */ jsxs("button", {
					onClick: () => setTab(t),
					...
					children: [t === "experiments" ? `Experiments${experiments.length ? ` (${experiments.length})` : ""}` : "Settings", tab === t && /* @__PURE__ */ jsx("span", { className: "absolute bottom-0 left-0 right-0 h-[2px] bg-foreground rounded-t-full" })]
				}, t))
			}), /* @__PURE__ */ jsx("div", {
				className: "flex-1 overflow-y-auto",
				children: tab === "settings" ? /* @__PURE__ */ jsx(SettingsPanel, {
					modelId,
					setModelId,
					modelOpen,
					setModelOpen,
		...
		children: [
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					})] }), /* @__PURE__ */ jsx(CaretRight, { className: `h-4 w-4 text-muted-foreground/50 transition-transform duration-150 ${modelOpen ? "rotate-90" : ""}` })]
				}), modelOpen && /* @__PURE__ */ jsx("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("span", {
											className: "text-[14px] font-medium text-foreground",
											children: m.label
										}), selected && /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-foreground" })]
									}),
									/* @__PURE__ */ jsx("div", {
										className: "text-[12.5px] text-muted-foreground mt-0.5",
										children: m.sublabel
...
function ExperimentsPanel({ experiments, playingId, setPlayingId, onLoad }) {
	if (experiments.length === 0) return /* @__PURE__ */ jsxs("div", {
			...
			return /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("button", {
						...
						children: playing ? /* @__PURE__ */ jsx(Pause, {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: [
										/* @__PURE__ */ jsx(Lightning, { className: "h-3 w-3" }),
										exp.latencyMs,
										"ms"
									]
								})]
							...
							playing && /* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(Waveform$1, {
									bars: 36,
									playing
								})
							})
