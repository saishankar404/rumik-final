...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Bks3Q6kq.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-CCUPfPIz.js"),
		import("./assets/start-DgpLufzy.js"),
		import("./assets/empty-plugin-adapters-Br_mqi0s.js")
	]);
	return {
		routerEntry,
		startEntry,
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-start@1.168.26_crossws@0.4.6_srvx@0.11.17__react-dom@19.2.7_react@19.2._70c7e1835a2939e2f9862954f1eeaa96/node_modules/@tanstack/react-start/dist/plugin/default-entry/server.ts
