  ...
  head: () => ({
    meta: [
      { title: "Support — Rumik AI" },
      {
        name: "description",
        content:
          "Talk to the team, browse docs, or join the developer community.",
      },
    ],
  }),
  component: Support,
...
const CHANNELS = [
  {
    ...
    ariaLabel: "Email support at hello@rumik.ai",
  },
  {
    icon: BookOpen,
    title: "Documentation",
    ...
    ariaLabel: "Documentation at docs.rumik.ai",
  },
  {
    icon: ChatCircle,
    ...
    action: "Join server",
    ariaLabel: "Join the Discord community server",
  },
];
  ...
  return (
    <>
      ...
      <div className="-mx-3 hairline-t animate-fade-in">
        {CHANNELS.map(({ icon: Icon, title, hint, action, ariaLabel }) => (
          <a
            key={title}
            href="#"
